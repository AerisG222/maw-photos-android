...
private fun SettingsRoute(vm: SettingsViewModel = hiltViewModel()) {
    ...
    SettingsScreen(
        ...
        onCategoryShowFavoriteIndicatorChange = { vm.setCategoryShowFavoriteIndicator(it) },
        ...
        onPhotoShowFavoriteIndicatorChange = { vm.setPhotoShowFavoriteIndicator(it) },
        ...
        onRandomShowFavoriteIndicatorChange = { vm.setRandomShowFavoriteIndicator(it) },
        ...
        onSearchShowFavoriteIndicatorChange = { vm.setSearchShowFavoriteIndicator(it) },
        onPeopleThumbnailSizeChange = { vm.setPeopleThumbnailSize(it) },
        ...
        onPeopleShowCategoryYearChange = { vm.setPeopleShowCategoryYear(it) },
        onPeopleShowCategoryTitleChange = { vm.setPeopleShowCategoryTitle(it) },
        onPlaceShowCategoryYearChange = { vm.setPlaceShowCategoryYear(it) },
        onPlaceShowCategoryTitleChange = { vm.setPlaceShowCategoryTitle(it) },
