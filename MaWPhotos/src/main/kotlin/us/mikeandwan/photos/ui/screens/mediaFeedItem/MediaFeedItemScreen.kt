...
fun MediaFeedItemScreen(
    ...
    ItemPagerScaffold(
        ...
        topRightContent = {
            // counts what has been loaded rather than what the feed holds: the API does not say how
            // many there are in total, and a running count is honest about a feed still being paged
