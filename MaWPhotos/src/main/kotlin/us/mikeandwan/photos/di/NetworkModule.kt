...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideCategoryApiClient(retrofit: Retrofit): CategoryApiClient = CategoryApiClient(retrofit)
    ...
    @Provides
    @Singleton
    fun provideUploadApiClient(retrofit: Retrofit): UploadApiClient = UploadApiClient(retrofit)
}
