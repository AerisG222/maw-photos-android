...
class MawDatabaseCreateCallback : Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL(
            "INSERT INTO category_preference (id, display_type, grid_thumbnail_size, show_media_type_indicator, show_favorite_indicator) VALUES (1, '${CategoryDisplayType.Grid}', '${GridThumbnailSize.Medium}', 1, 1)",
        )
        db.execSQL(
        ...
        db.execSQL(
            "INSERT INTO people_preference (id, sort_by, grid_thumbnail_size, show_names, show_media_counts, show_clans, show_category_year, show_category_title) VALUES (1, '${PersonSort.Name}', '${GridThumbnailSize.Medium}', 1, 1, 1, 1, 1)",
        )
        db.execSQL(
        ...
        db.execSQL(
            "INSERT INTO search_preference (id, recent_query_count, display_type, grid_thumbnail_size, show_media_type_indicator, show_favorite_indicator) VALUES (1, 20, '${CategoryDisplayType.Grid}', '${GridThumbnailSize.Medium}', 1, 1)",
        )
    }
}
